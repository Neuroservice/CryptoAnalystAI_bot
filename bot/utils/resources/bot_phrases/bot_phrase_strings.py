...
phrase_dict = {
    "RU": {
        ...
        "input_categories": "Если каких-либо данных для проекта нет, отправьте '-'\nВведите категории проекта через запятую (например: Layer 1, TRON Ecosystem):",
        "input_market_price": "Введите рыночную цену (https://coinmarketcap.com/):",
...
""",
    ...
    "ENG": {
        ...
        "input_categories": "If there is no data for the project, send '-'\nEnter the project categories separated by commas (eg: Layer 1, TRON Ecosystem):",
        "input_market_price": "Enter market price (https://coinmarketcap.com/):",
