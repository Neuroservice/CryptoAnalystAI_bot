...
METRICS_MAPPING = {
    ...
    'total_supply': {'RU': 'Общее количество токенов (Total Supply)', 'ENG': 'Total Supply'},
    'fundraising': {'RU': 'Сумма сбора средств от инвесторов (Fundraising)', 'ENG': 'Fundraising'},
    'twitter_followers': {'RU': 'Количество подписчиков на Twitter', 'ENG': 'Twitter followers'},
    'twitter_score': {'RU': 'Twitter Score', 'ENG': 'Twitter Score'},
    'tvl': {'RU': 'Общая стоимость заблокированных активов (TVL)', 'ENG': 'Total Value Locked (TVL)'},
    'top_100_wallet': {'RU': 'Процент нахождения токенов на топ 100 кошельков блокчейна', 'ENG': 'Percentage of tokens on top 100 wallets'},
