...
class Project(Base):
    ...
    categories = relationship("Category", secondary=project_category_association, back_populates="projects")
...
class Category(Base):
    ...
    projects = relationship("Project", secondary=project_category_association, back_populates="categories")
