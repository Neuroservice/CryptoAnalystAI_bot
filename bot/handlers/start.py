...
async def start_command(message: types.Message, state: FSMContext):
    ...
    async with SessionLocal() as session:
        ...
        if user.language:
            ...
            await message.answer(phrase_by_user("hello_phrase", user.telegram_id), reply_markup=main_menu_keyboard(language=user.language))

        else:
            await message.answer("Please choose your language / Пожалуйста, выберите язык:", reply_markup=language_keyboard())
